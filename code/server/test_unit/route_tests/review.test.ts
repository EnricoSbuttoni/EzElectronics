...
describe("ReviewRoutes tests", () => {
    ...
    describe('DELETE /reviews', () => {
        it('should delete all reviews and return status 200', async () => {
            
            jest.spyOn(mockAuthenticator, 'isLoggedIn').mockImplementation((req, res, next) => next());
            jest.spyOn(mockAuthenticator, 'isAdminOrManager').mockImplementation((req, res, next) => next());
